...
module.exports = {
    ...
    exec: async (m, client) => {
        ...
        await delay(2000)
        const btn = [
            { urlButton: { displayText: `Web`, url: `https://fardev78.my.id` } },
            { urlButton: { displayText: `Instagram`, url: `https://www.instagram.com/fardev78.id` } },
            { urlButton: { displayText: `Github`, url: `https://github.com/Satria356` } },
